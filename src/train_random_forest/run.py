...
def go(args):
    ...
    # Save model metrics to W&B summary
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # Create the inference pipeline with two steps:
    # 1 - a step called "preprocessor" applying the ColumnTransformer instance
    # 2 - a step called "random_forest" with the random forest instance
    sk_pipe = Pipeline(
        steps =[
